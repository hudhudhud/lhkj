<template>
  <LayoutPage class="content-mer">
    <LayoutSearch>
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="add" :loading="loading">新增4s店</el-button>
        </el-form-item>
      </el-form>
    </LayoutSearch>
    <LayoutTable :disableAutoHeight="true" ref="myTable" url="homeCar/sz/hl/store/like/name" :param="searchForm"
      ...
      <el-table-column :show-overflow-tooltip="true" align="center" min-width="200" prop="name" label="4s店名称">
      </el-table-column>
      ...
      <el-table-column align="center" min-width="100" label="中心车辆">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$router.push("/ssshenghuo/addMerchant/mer");
    },
    handleView(row) {
      this.$router.push("/ssshenghuo/ssCarList?id=" + row.id);
    },
    ...
    onEdit(id) {
      this.$router.push("/ssshenghuo/addMerchant/mer?id=" + id);
    }
  }
};
</script>

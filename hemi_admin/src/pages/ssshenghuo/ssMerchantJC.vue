    ...
    <LayoutSearch>
      <el-form :inline="true" :model="searchForm">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="add" :loading="loading">新增商户</el-button>
        </el-form-item>
      </el-form>
    </LayoutSearch>
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$router.push("/ssshenghuo/addMerchant/jc");
    },
    handleView(row) {
      this.$router.push("/ssshenghuo/ssProductJC?id=" + row.id);
    },
    ...
    onEdit(id) {
      this.$router.push("/ssshenghuo/addMerchant/jc?id=" + id);
    },
    showInput() {

<template>
  <div class="page">
    <img class="tplsSurface" :src="tplsSurface" />
    <div class="dialog" v-if="tel.key">
      <div class="main">
        <div class="container">
          <img :src="tpl.DialogBg" v-highLight="'DialogBg'" alt="" class="banner">
          <div class="ruleCont">
            <img v-if="tpl.prizeImg" :src="tpl.prizeImg" alt="" v-highLight="'prizeImg'">
            <p>商品名称</p>
          </div>
          <!-- <img :src="setting.btn" alt="" class="btn" @click="createOrder(setting)"> -->
        </div>
        <img class="close" :src="tpl.DialogClose" v-highLight="'DialogClose'" alt="">
      </div>
    </div>
  </div>
</template>

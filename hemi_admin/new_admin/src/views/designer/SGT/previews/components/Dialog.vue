<template>
  <div class="page">
    ...
    <div class="dialog">
      <div class="main">
        <div class="container">
          <img :src="tpl.prizeDialogBg" v-highLight="'prizeDialogBg'" alt="" class="banner">
          <div class="ruleCont">
            <img :src="tpl.prizeImg" alt="" v-highLight="'prizeImg'">
            <p>商品名称</p>
          </div>
          <!-- <img :src="setting.btn" alt="" class="btn" @click="createOrder(setting)"> -->
        </div>
        <img class="close" :src="tpl.ruleDialogClose" v-highLight="'ruleDialogClose'" alt="">
      </div>
    </div>
  </div>
</template>

<template>
  <div class="address">
    <headerBar title="编辑收货地址" :bgColor="'#5FB534'"></headerBar>
    <div class="main">
      <div class="inputtext">
      ...
      <div class="inputtext" @click="ShowProvince">
        <div class="title name">省份</div>
        <input type="text" placeholder="请选择省份" v-model="province" readonly>
        <div class="arrow">
          <img src="./imgs/arrow.png" alt>
        </div>
      </div>
      <div class="inputtext" @click="ShowCity">
        <div class="title name">城市</div>
        <input type="text" placeholder="请选择城市" v-model="city" readonly>
        <div class="arrow">
          <img src="./imgs/arrow.png" alt>
        </div>
      </div>
      <div class="inputtext" @click="ShowArea">
        <div class="title name">地区</div>
        <input type="text" placeholder="请选择地区" v-model="area" readonly>
        <div class="arrow">
          <img src="./imgs/arrow.png" alt>
        </div>
      </div>
      ...
      <div class="setaddress">
        ...
        <div class="button" @click="setDefault">
          <img src="./imgs/on.png" alt v-if="isDefault == 1">
          <img src="./imgs/off.png" alt v-else>
        </div>
      </div>
      <!-- 省份 -->
      <mt-popup
      ...
      >
        ...
        >
          <div class="picker-toolbar-title">
            <div class="usi-btn-cancel" @click="provinceVisible = !provinceVisible">取消</div>
            <div class="usi-btn-sure" @click="provinceVisible = !provinceVisible">确定</div>
          </div>
        </mt-picker>
        <!-- <mtPicker></mtPicker> -->
      </mt-popup>
      ...
      <mt-popup
        ...
        position="bottom"
      >
        <mt-picker :slots="citySlots" @change="onCityChange" style="width: 7.5rem;" showToolbar>
          <div class="picker-toolbar-title">
            <div class="usi-btn-cancel" @click="cityVisible = !cityVisible">取消</div>
            <div class="usi-btn-sure" @click="cityVisible = !cityVisible">确定</div>
          </div>
        </mt-picker>
      </mt-popup>
      <!-- 地区 -->
      <mt-popup
        ...
        position="bottom"
      >
        <mt-picker :slots="areaSlots" @change="onAreaChange" style="width: 7.5rem;" showToolbar>
          <div class="picker-toolbar-title">
            <div class="usi-btn-cancel" @click="areaVisible = !areaVisible">取消</div>
            <div class="usi-btn-sure" @click="areaVisible = !areaVisible">确定</div>
          </div>
        </mt-picker>
      </mt-popup>
    </div>
    <div class="save" @click="savaAddress">保存地址</div>
  </div>
</template>

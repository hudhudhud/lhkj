...
"
        ...
        <div class="modal-main">
          ...
          >恭喜您获得{{payload.prizeName}}<span v-if="payload.proType == 10">手机一台</span>
...
"
        ...
        <!-- 抽奖结果 -->
        <div class="modal-main">
          <div class="gratulation">恭喜您获得{{payload.proStandardName}}<span v-if="payload.proType == 10">手机一台</span></div>

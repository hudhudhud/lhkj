<template>
  <div>
    <div class="bgj-sign">
      <back></back>
      <div class="bg">
        <img :src="templateConfig.pageBgImg" alt>
      </div>
      <div class="bgj-main">
        <div class="sign-bar">
          ...
          <div class="sign-activity" :style="{'backgroundImage': 'url(' + templateConfig.chargeImg+')'}">
            <div class="sign-count">
              <div v-for="(item,index) in  arr" :key="'num' + index">
                <div v-if="item==signedTotal+1 && !isSigned" @click="doSign" class="todayactive" :style="{'backgroundImage': 'url(' + templateConfig.signImg+')'}">
                  <span>次数</span>
                  <span>{{item}}</span>
                </div>
                <div v-else-if="item< signedTotal+1 " class="active" :style="{'backgroundImage': 'url(' + templateConfig.signedImg+')'}">
                  <span>次数</span>
                  <span>{{item}}</span>
                </div>
                <div v-else :style="{'backgroundImage': 'url(' + templateConfig.waitSignImg+')'}">
                  <span>次数</span>
                  <span>{{item}}</span>
                </div>
              </div>
            ...
            <div class="sign-getter" v-for="(prize,ind) in prizeList" :key="'prize'+ind">
              ...
              <div class="sign-receive" :style="{'backgroundImage': 'url(' + tpl.receiveBtnImg+')'}" v-if="prize.drawState==1"
                @click="getPrize(prize)">领取</div>
          ...
          <div class="rules">
            <img :src="templateConfig.ruleTitleImg" alt="">
          </div>

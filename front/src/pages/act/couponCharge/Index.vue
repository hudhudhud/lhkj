<template>
  <div>
    <cbbHeader :title="templateConfig.title"></cbbHeader>
    <div class="buy">
      <div class="phone">
        ...
        <input
          type="text"
          v-model="account"
          :placeholder="'请输入'+act.productList[0].standardList[0].accountName"
        >
      </div>

      <div class="phone">
        <div class="label">优惠券码</div>
        <input type="text" v-model="couponNumber" placeholder="请输入优惠券码">
      </div>

<template>
  <div class="bg">
    <cbbHeader title="南宁专区"></cbbHeader>
    <div class="title">南宁专区</div>
    <div class="wrapper">
      <div class="container">
        <div
          class="area-item"
...
export default {
  ...
  created () {
    this.getLocalBanksBranch(this.$route.query.areaId);
  }
};
</script>

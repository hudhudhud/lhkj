...
import LegoLocalBankNew from './LegoLocalBank/Index';
import LegoLocalBankAnhui from './LegoLocalBank002/Index';
...
import LegoLettery from './lettery/Index';
...
import LegoShare from './LegoShare/Index'; // 微信分享组件
...
const components = [
  ...
  },
  {
    ...
    component: LegoImage,
    isContainer: false,
    props: [{ name: '图片', key: 'src', type: 'image' }].concat(commonProps),
    defaultSetting: {
      src:
        '//lianhai-static.oss-cn-hangzhou.aliyuncs.com/lib%2Fimgs%2Fdefault.jpg'
    },
    defaultStyle: {
      display: 'block',
      'max-width': '100%'
  ...
  },
  {
    ...
    isContainer: false,
    props: [
      { name: '图片列表', key: 'list', type: 'swiper', default: [] },
      { name: '间隔时间', key: 'delay', type: 'text', default: '2000' },
      { name: '切换速度', key: 'speed', type: 'text', default: '300' }
    ],
    defaultSetting: {
      list: [
        {
  ...
  },
  {
    ...
    props: [],
    slotProps: [
      { name: '客户编号', key: 'customId' },
      { name: '昵称', key: 'nickname' },
      { name: '商户号', key: 'merchantId' },
      { name: '绑定手机号', key: 'tel' },
      { name: '头像', key: 'headImgUrl' },
      { name: '注册时间', key: 'registryTime' }
    ],
    defaultStyle: {}
  },
  {
    ...
    isContainer: true,
    props: [{ name: '商品规格', key: 'standardId', type: 'standard' }],
    slotProps: [
      { name: '商品ID', key: 'proId' },
      { name: '商品名称', key: 'proName' },
      { name: '规格ID', key: 'standardId' },
      { name: '规格名称', key: 'standardName' },
      { name: '规格图片', key: 'standardImgUrl' },
      { name: '规格说明', key: 'standardInstruction' }
    ],
    defaultStyle: {
      height: '100px',
      width: '100px',
  ...
  },
  {
    ...
    isContainer: true,
    props: [{ name: '商品', key: 'proId', type: 'product' }],
    slotProps: [
      { name: '商品ID', key: 'proId' },
      { name: '商品名称', key: 'proName' },
      { name: '规格ID', key: 'standardId' },
  ...
  },
  {
    ...
    isContainer: true,
    props: [
      { name: '商品', key: 'proId', type: 'product' },
      { name: '充值说明', key: 'desc', type: 'text' }
    ],
    defaultStyle: {}
  },
  {
  ...
  },
  {
    ...
    isContainer: true,
    props: [{ key: 'json', name: 'json', type: 'text' }]
  },
  {
    name: '工行充值组件',
    desc: '',
  ...
  },
  {
    ...
    isContainer: true,
    props: [{ name: 'defaultAvatar', key: 'defaultAvatar', type: 'text' }]
  },
  {
    name: '八桂兑换专区弹出框',
    desc: '广西八桂八桂金',
  ...
  },
  {
    ...
    isContainer: true,
    props: [
      { name: 'targetUrl', key: 'targetUrl', type: 'text' },
      { name: 'actId', key: 'actId', type: 'text' }
    ]
  },
  {
    name: '首页活动入口弹框模板',
  ...
  },
  {
    ...
    isContainer: true,
    props: [
      { name: '目标链接', key: 'targetUrl', type: 'text' },
      { name: '默认邀请码', key: 'pass', type: 'text' }
    ]
  },
  {
    name: '苏建小贴士',
  ...
  },
  {
    name: '安徽中行地方行',
    desc: '',
    tag: 'lego-local-bank-anhui',
    icon: '',
    component: LegoLocalBankAnhui,
    isContainer: true
  },
  {
    name: '八桂金兑换活动选项卡',
  ...
  },
  {
    ...
    defaultSetting: {
      banner:
        '//static.lianhaikeji.com/images/20180928/cf54666dcbf44fc3a305c584e7038f6a.png',
      btnOn:
        '//static.lianhaikeji.com/images/20180928/60055cf0f27b4eb0b61e7f07988dd339.png',
      btnSuccess:
        '//static.lianhaikeji.com/images/20180928/0484f235f4da4db8bb99fdee257fe4ac.png'
    },
    defaultStyle: {}
  },
  {
  ...
  },
  {
    ...
    isContainer: true,
    props: [
      { name: '活动id', key: 'actid', type: 'text' },
      { name: 'ul样式', key: 'ulStyle', type: 'text' },
      { name: 'li样式', key: 'liStyle', type: 'text' },
      { name: '按钮样式', key: 'btnStyle', type: 'text' },
      { name: '按钮文字', key: 'btnText', type: 'text' }
    ],
    defaultStyle: {}
  },
  {
  ...
  },
  {
    ...
    isContainer: true,
    props: [
      { name: '分享正标题', key: 'title', type: 'text' },
      { name: '分享副标题', key: 'desc', type: 'text' },
      { name: '分享链接', key: 'link', type: 'text' },
      { name: '分享图片', key: 'imgUrl', type: 'image' }
    ],
    defaultStyle: {}
  }, {
    name: 'ETC热门商品',

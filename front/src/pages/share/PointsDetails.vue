<template>
  <div class="details-wrapper">
    <div class="tab-title-wrapper">
      ...
      <div class="table-title-item" :class="{'active':currentTab=='receive'}" @click="currentTab='receive'">
        <span class="tt-item-text">积分获得明细</span>
      </div>
      <div class="table-title-item" :class="{'active':currentTab=='spend'}" @click="currentTab='spend'">
        <span class="tt-item-text">积分使用明细</span>
      </div>
    </div>
    <div class="tab-content-wrapper" v-infinite-scroll="loadDataList" infinite-scroll-immediate-check="false" infinite-scroll-disabled="noMore" infinite-scroll-distance="10">
...
import {loadDataList} from './api/api.js'
export default {
  data () {
    return {
      currentTab: 'receive',

<template>
  ...
  <div>
    <div class="main">
      <div class="rules" @click="rulesShow = true">活动规则</div>
      <div class="main-head">
          ...
          <div class="info">
            ...
            <div class="info-item">
              <a :href="`${protocol}//${host}/${$store.state.merchantAppid}/merchant/index/credit`">
                <div class="num" v-if="useableCredit">{{useableCredit}}</div>
                <div class="nonum" v-else>暂无积分</div>
        ...
        <div class="recommend">
          <div class="carhandle-item" @click="gotocarget">我要办卡</div>
          <div class="recommend-item" @click="gotoqrcode">我要推荐</div>
        </div>
      </div>
      <div class="main-tab">
        <div class="tab-item">
          <a :href="`${protocol}//${host}/${$store.state.merchantAppid}/merchant/index/credit`">
            <img class="top-pic" src="./imgs/pointdetail.png" alt />
            <img class="top-bottom" src="./imgs/pointdetailword.png" alt />
          </a>
        </div>
        <div class="tab-item">
          <a :href="`${protocol}//${host}/${$store.state.merchantAppid}/merchant/lego/a4c7c910c189427cb06269b1006c8b51`">
            <img class="top-pic" src="./imgs/mall.png" alt />
            <img class="top-bottom" src="./imgs/mallword.png" alt />
          </a>
        </div>
        <div class="tab-item">
          <a href="https://mp.weixin.qq.com/mp/homepage?__biz=MjM5NjQyNjc2MA==&hid=12&sn=c7343009f76dfb8798b79e204c6808fc">
      ...
      <div class="product">
        <div class="product-item">
          <a href="https://mp.weixin.qq.com/s/yOe43JRkmhYRAk6jCLl9-A">
      ...
      <div class="product">
        <a href="https://mp.weixin.qq.com/mp/homepage?__biz=MjM5NjQyNjc2MA==&hid=20&sn=74f7f0a3c3363a7f30300c96d5fa80d0&scene=18">
...
export default {
  ...
  methods: {
    ...
    async gotocardtip () {
      this.$router.push('cardnotice'); // 去用卡小知识
    },
    async gotoqrcode () {
      window.location.href = `//${window.location.host}/partner/shzh/share/${
    ...
    gotoSign () {
      window.location.href = `${this.protocol}//${this.host}/${
        this.$store.state.merchantAppid
      }/merchant/index/act/${config.signActId}`;
    },
    getheadImgUrl () {

<template>
  <div class="hemi-rotate">
    <div class="award">
      ...
      <img @click="start" class="award-pointer" :src="setting.pointerImage" />
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      templateConfig: {
        ...
        icons: ['//static.lianhaikeji.com/images/20190708/e3cbe0ba7e754a3393cc36f02500d544.png', '//static.lianhaikeji.com/images/20190708/e3cbe0ba7e754a3393cc36f02500d544.png', '//static.lianhaikeji.com/images/20190708/e3cbe0ba7e754a3393cc36f02500d544.png', '//static.lianhaikeji.com/images/20190708/e3cbe0ba7e754a3393cc36f02500d544.png', '//static.lianhaikeji.com/images/20190708/e3cbe0ba7e754a3393cc36f02500d544.png', '//static.lianhaikeji.com/images/20190708/e3cbe0ba7e754a3393cc36f02500d544.png'],
        startAngle: 0, // 开始角度
  ...
  methods: {
    ...
    rotate(prize) {
      ...
      angles = angles + this.rotateBaseDeg - 360 / this.templateConfig.names.length;
    ...
    async drawPannel() {
      ...
      for (let i = 0; i < this.templateConfig.names.length; i++) {
        ...
        let color = i % 2 == 0 ? this.setting.pannelColor1 : this.setting.pannelColor2
